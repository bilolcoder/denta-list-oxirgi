...
const Login = () => {
    ...
    const { loginWithPhone } = dataContext;
    ...
    const handleSmsConfirm = async (code) => {
        ...
        try {
            ...
            let username = fullPhone.replace('+998', '9'); // fallback
            ...
            try {
                ...
                if (meResponse.ok) {
                    ...
                    if (meData.user) {
                        ...
                        userRole = meData.user.role || 'OPERATOR';
                        userId = meData.user.id || meData.user._id;
                    }
                }
            } catch (meErr) {
                console.error('api/auth/me xatosi:', meErr);
            }
    ...
    return (
        <>
            ...
            <div className="flex min-h-screen w-full overflow-hidden font-sans">
                {/* Chap taraf - rasm (katta ekranlar uchun) */}
                            ...
                            <div className="space-y-6">
                                <div className="flex items-center justify-between mb-2">
                                    <button
                                        ...
                                        className="flex items-center gap-2 text-gray-600 hover:text-gray-900 transition-colors p-2 -ml-2"
                                    >
