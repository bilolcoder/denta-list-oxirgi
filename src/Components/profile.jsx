...
const ProfileContent = () => {
  ...
  useEffect(() => {
    const fetchProfile = async () => {
      ...
      try {
        ...
        console.log('ProfileContent API response:', data);
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      // Yangi ma'lumotlarni local state da yangilash
      ...
      // currentImage ni yangilash (darhol ko'rinishi uchun)
      setFormData(prev => ({
        ...prev,
        currentImage: formData.image || prev.currentImage,
        image: null
      }));

      // Boshqa joylarda ishlatish uchun localStorage (faqat kerakli maydonlar)
