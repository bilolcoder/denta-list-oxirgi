...
function DoctorCard({ id, img, name, job, rating, distance, price, patients, exp, service }) {
  ...
  return (
    <div className="w-full bg-white rounded-[10px] overflow-hidden shadow-md hover:shadow-lg transition-shadow duration-300">
      ...
      <div className="px-3 py-3">
        ...
        <p className="text-gray-500 text-[12px] mt-[-16px]">{job}</p>
        ...
        <p className="font-semibold text-[15px] mt-1.5 text-blue-600">
          {price}
        </p>
